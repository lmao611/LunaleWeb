...
import { X, ChevronLeft, ChevronRight, ShoppingCart, QrCode, CheckCircle } from "lucide-react";
    ...
    <div className="max-w-5xl mx-auto p-6 bg-white text-gray-900 pt-30">
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="flex-1 flex flex-col">
          ...
          <img src="/model.jpg" alt="Model Size" className="mt-6 rounded-lg shadow-lg w-full object-cover select-none" />
          <img src="/size.jpg" alt="Size Chart" className="mt-6 rounded-lg shadow-lg w-full object-contain bg-white select-none" onMouseDown={stopDown} />
        </div>
      </div>
                        ...
                        {!showQR ? (
                           <div className="space-y-4">
                               <div className="flex gap-4 mb-4">
                                   <img src={mainImage} className="w-20 h-24 object-cover rounded border select-none" alt="prod"/>
                                   <div>
                           ...
                           <div className="text-center">
                               ...
                               <div className="border-2 border-blue-500 rounded-lg p-2 inline-block mb-4 max-w-full">
                                   <img src="/qr-payment.jpg" alt="QR Code" className="w-full max-w-[400px] h-auto object-contain mx-auto select-none" />
                               </div>
                ...
                {({ zoomIn, zoomOut, resetTransform, centerView }) => (
                  <>
                    ...
                    <TransformComponent wrapperClass="!w-full !h-full">
                      <img src={zoomImage} alt="Zoomed" className="max-h-screen max-w-screen object-contain select-none" draggable="false" />
                    </TransformComponent>
                  </>
                )}
              </TransformWrapper>
