        ...
        <div className="flex-1 flex flex-col">
          <div className="p-6 rounded-xl border border-gray-200 bg-white shadow-lg space-y-4">
            ...
            <div className="mt-4 flex gap-3">
              <button type="button" onClick={(e) => { e.preventDefault(); e.stopPropagation(); setShowContactModal(true) }} className="flex-1 flex items-center justify-center gap-2 px-4 py-3 rounded-lg bg-white hover:bg-gray-400 text-gray-800 font-medium transition active:scale-95 shadow-sm">LIÊN HỆ</button>
